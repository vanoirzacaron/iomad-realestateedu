...
$string['message_preset_help'] = 'Enter a time delay using the units provided after which to send the message.';
$string['message_time'] = 'Send message time';
$string['message_time_help'] = 'Enter a scheduled time at which the message will be sent.';
