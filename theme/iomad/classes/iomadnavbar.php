...
class iomadnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_iomad();
    }

    /**
     * Prepares the navigation nodes for use with iomad.
     */
    protected function prepare_nodes_for_iomad(): void {
        global $PAGE;
    ...
    /**
     * Get all the iomadnavbaritem elements.
     *
     * @return iomadnavbaritem[] IOMAD navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this iomad navbar
     */
    ...
    /**
     * Remove a iomadnavbaritem from the iomad navbar.
     *
     * @param  string|int $itemkey An identifier for the iomadnavbaritem
     * @param  int|null $itemtype An additional type identifier for the iomadnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the iomadnavbaritem.
     */
