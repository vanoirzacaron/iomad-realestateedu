 ...
 *
 * @module     theme_iomadboost/drawers
...
// The jQuery module is only used for interacting with IOMAD Boostrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in IOMAD Boostrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_iomadboost/drawers:show}
     * @property {String} drawerShown See {@link event:theme_iomadboost/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_iomadboost/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_iomadboost/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_iomadboost/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_iomadboost/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_iomadboost/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_iomadboost/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_iomadboost/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_iomadboost/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_iomadboost/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_iomadboost/drawers:hidden',
    };
     ...
     * @returns {module:theme_iomadboost/drawers}
     */
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_iomadboost/drawers:close');
     ...
     *
     * @param {module:theme_iomadboost/drawers} comparisonInstance
     */
